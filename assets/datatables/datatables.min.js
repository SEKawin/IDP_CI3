...
(function(l) {
    ...
    function Ba(a) {
        ...
        } else setTimeout(function() { Ba(a) }, 200)
    }
    ...
    u.util = {
        ...
        get: function(a) {
            if (l.isPlainObject(a)) {
                ...
                return function(d, e, h, g) { var f = b[e] || b._; return f !== q ? f(d, e, h, g) : d }
            }
    ...
    var tb = function(a, b, c, d, e) {
            ...
            n = 0;
            for (f = b.length; n < f; n++) { var m = b[n] && b[n].split && !b[n].match(/[\[\(:]/) ? b[n].split(",") : [b[n]]; var p = 0; for (k = m.length; p < k; p++)(g = c("string" === typeof m[p] ? m[p].trim() : m[p])) && g.length && (h = h.concat(g)) }
            a = M.selector[a];
            if (a.length)
        ...
        Va = function(a, b) {
            ...
            if ("current" == b)
                ...
                if ("removed" == h) {
                    ...
                    c = l.map(e, function(k) { return f.hasOwnProperty(k) ? null : k })
                }
    ...
    y("rows()", function(a, b) {
        ...
        b = ub(b);
        var c = this.iterator("table", function(d) { return vc(d, a, b) }, 1);
        c.selector.rows = a;
        c.selector.opts = b;
        return c
    });
    ...
    l(A).on("plugin-init.dt", function(a, b) {
        ...
        c.on("stateSaveParams", function(d, e, h) {
            d = c.rows().iterator("row", function(g, f) { return g.aoData[f]._detailsShow ? f : q });
        ...
        zc = function(a, b, c) {
            ...
            return tb("column", b, function(g) {
                ...
                if (n) switch (n[2]) {
                    ...
                    case "visible":
                        f = parseInt(n[1], 10);
                        if (0 > f) { var m = l.map(d, function(p, t) { return p.bVisible ? t : null }); return [m[m.length + f]] }
                        return [ua(a, f)];
                    case "name":
    ...
    y("columns()", function(a, b) {
        a === q ? a = "" : l.isPlainObject(a) && (b = a, a = "");
        b = ub(b);
        var c = this.iterator("table", function(d) { return zc(d, a, b) }, 1);
        c.selector.cols = a;
        c.selector.opts = b;
        return c
    });
        ...
        return tb("cell", b, function(w) {
            ...
            if (null === w || w === q || r) {
                ...
                for (p = e.length; m < p; m++)
                    for (f = e[m], t = 0; t < k; t++) v = { row: f, column: t }, r ? (x = d[f], w(v, T(a, f, t), x.anCells ? x.anCells[t] : null) && n.push(v)) : n.push(v);
                return n
            }
    ...
    y("cells()", function(a, b, c) {
        ...
        d = this.iterator("table", function(m, p) {
            ...
            for (f = h[p].length; g < f; g++)
                for (k = 0, n = e[p].length; k < n; k++) m.push({ row: h[p][g], column: e[p][k] });
            return m
        }, 1);
    ...
    l.each(["column", "row", "cell"], function(a, b) {
        y(b + "s().every()", function(c) {
            var d = this.selector.opts,
                e = this;
            return this.iterator(b, function(h, g, f, k, n) { c.call(e[b](g, "cell" === b ? f : d, "cell" === b ? d : q), g, f, k, n) })
        })
    });
    ...
    l.extend(u.ext.type.detect, [function(a, b) { b = b.oLanguage.sDecimal; return sb(a, b) ? "num" + b : null }, function(a, b) {
        if (a && !(a instanceof Date) && !sc.test(a)) return null;
        b = Date.parse(a);
        return null !== b && !isNaN(b) || Z(a) ? "date" : null
    }, function(a, b) { b = b.oLanguage.sDecimal; return sb(a, b, !0) ? "num-fmt" + b : null }, function(a, b) { b = b.oLanguage.sDecimal; return ic(a, b) ? "html-num" + b : null }, function(a, b) { b = b.oLanguage.sDecimal; return ic(a, b, !0) ? "html-num-fmt" + b : null }, function(a, b) {
