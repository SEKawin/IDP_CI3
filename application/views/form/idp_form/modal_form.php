...
<script type="text/javascript">
	...
	function form_idp_plan(idp_form_id) {
		...
		$.ajax({
			url: "<?php echo site_url('idp_form/competency_form') ?>/" + idp_form_id,
			type: "GET",
			dataType: "JSON",
			success: function(data) {
				//  Core Competency 
				let a = 1;
				$('#modal_form_idp_plan #tbody_CC').html('');
				$.each(data.cc_result, function(key, value) {
					$('#modal_form_idp_plan #tbody_CC').append(`
						<tr>
							<td><input type="text" class="form-control" id="no" name="params_cc[${[a]}][no]" value="${[a]}"></td>
							<td>
								<textarea class ="form-control "name="params_cc[${[a]}][competency]" id="competency" cols="20" rows="2" value="${[value]}">${[value]}</textarea>
							</td>
							<td>
							...
							<td><textarea id="tool_deital" name="params_cc[${[a]}][tool_deital]" class="form-control"></textarea></td>
							<td><input type="text" id="dev_time" name="params_cc[${[a]}][dev_time]" class="form-control" placeholder="ระบุ Q1-Q4"></td>
							<td><textarea id="target" name="params_cc[${[a]}][target]" class="form-control"></textarea></td>
							<td><input type="number" min="1" step="any" id="budget" name="params_cc[${[a]}][budget]" class="form-control"></td>
							<td><textarea id="tracking" name="params_cc[${[a]}][tracking]" class="form-control" readonly="readonly"></textarea></td>
						</tr>
					    `);
					a++;
				})
				...
				// Manage Competency 
				let m = 1;
				$('#modal_form_idp_plan #tbody_MC').html('');
				if (data.mc_result == null) {
					$('#TopicMC').hide();
					$('#tbody_MC').hide();
				} else {
					$('#TopicMC').show();
					$.each(data.mc_result, function(key, value) {
						$('#modal_form_idp_plan #tbody_MC').append(`
						<tr>
							<td><input type="text" class="form-control" id="no" name="params_mc[${[m]}][no]" value="${[m]}"></td>
							<td>
								<textarea class ="form-control "name="params_mc[${[m]}][competency]" id="competency" cols="20" rows="2" value="${[value]}">${[value]}</textarea>
							</td>
							<td>
							...
							<td><textarea id="tool_deital" name="params_mc[${[m]}][tool_deital]" class="form-control"></textarea></td>
							<td><input type="text" id="dev_time" name="params_mc[${[m]}][dev_time]" class="form-control" placeholder="ระบุ Q1-Q4"></td>
							<td><textarea id="target" name="params_mc[${[m]}][target]" class="form-control"></textarea></td>
							<td><input type="number" min="1" step="any" id="budget" name="params_mc[${[m]}][budget]" class="form-control"></td>
							<td><textarea id="tracking" name="params_mc[${[m]}][tracking]" class="form-control" readonly="readonly"></textarea></td>
						</tr>
					    `);
						m++;
					})
				...
				// ความรู้(Knowledge)
				let b = 1;
				$('#modal_form_idp_plan #tbody_Know').html('');
				$.each(data.know_result, function(key, value) {
					$('#modal_form_idp_plan #tbody_Know').append(`
						<tr>
							<td><input type="text" class="form-control" id="no" name="params_know[${[b]}][no]" value="${[b]}"></td>
							<td>
								<textarea class ="form-control "name="params_know[${[b]}][competency]" id="competency" cols="20" rows="2" value="${[value]}">${[value]}</textarea>
							</td>
							<td>
							...
							<td><textarea id="tool_deital" name="params_know[${[b]}][tool_deital]" class="form-control"></textarea></td>
							<td><input type="text" id="dev_time" name="params_know[${[b]}][dev_time]" class="form-control" placeholder="ระบุ Q1-Q4"></td>
							<td><textarea id="target" name="params_know[${[b]}][target]" class="form-control"></textarea></td>
							<td><input type="number" min="1" step="any" id="budget" name="params_know[${[b]}][budget]" class="form-control"></td>
							<td><textarea id="tracking" name="params_know[${[b]}][tracking]" class="form-control" readonly="readonly"></textarea></td>
						</tr>
					    `);
					b++;
				})
				...
				// ทักษะ  Skill
				let c = 1;
				$('#modal_form_idp_plan #tbody_Skill').html('');
				$.each(data.skill_result, function(key, value) {
					$('#modal_form_idp_plan #tbody_Skill').append(`
						<tr>
							<td><input type="text" class="form-control" id="no" name="params_skill[${[c]}][no]" value="${[c]}"></td>
							<td>
								<textarea class ="form-control "name="params_skill[${[c]}][competency]" id="competency" cols="20" rows="2" value="${[value]}">${[value]}</textarea>
							</td>
							<td>
							...
							<td><textarea id="tool_deital" name="params_skill[${[c]}][tool_deital]" class="form-control"></textarea></td>
							<td><input type="text" id="dev_time" name="params_skill[${[c]}][dev_time]" class="form-control" placeholder="ระบุ Q1-Q4"></td>
							<td><textarea id="target" name="params_skill[${[c]}][target]" class="form-control"></textarea></td>
							<td><input type="number" min="1" step="any" id="budget" name="params_skill[${[c]}][budget]" class="form-control"></td>
							<td><textarea id="tracking" name="params_skill[${[c]}][tracking]" class="form-control" readonly="readonly"></textarea></td>
						</tr>
					    `);
					c++;
				})
				...
				// คุณลักษณะพิเศษส่วนบุคคล Personal Attributes
				let d = 1;
				$('#modal_form_idp_plan #tbody_PerAtt').html('');
				$.each(data.perattr_result, function(key, value) {
					$('#modal_form_idp_plan #tbody_PerAtt').append(`
						<tr>
							<td><input type="text" class="form-control" id="no" name="params_perattr[${[d]}][no]" value="${[d]}"></td>
							<td>
								<textarea class ="form-control "name="params_perattr[${[d]}][competency]" id="competency" cols="20" rows="2" value="${[value]}">${[value]}</textarea>
							</td>
							<td>
							...
							<td><span id="textbox_model_perattr"></span></td>
							<td><textarea id="tool_deital" name="params_perattr[${[d]}][tool_deital]" class="form-control"></textarea></td>
							<td><input type="text" id="dev_time" name="params_perattr[${[d]}][dev_time]" class="form-control" placeholder="ระบุ Q1-Q4"></td>
							<td><textarea id="target" name="params_perattr[${[d]}][target]" class="form-control"></textarea></td>
							<td><input type="number" min="1" step="any" id="budget" name="params_perattr[${[d]}][budget]" class="form-control"></td>
							<td><textarea id="tracking" name="params_perattr[${[d]}][tracking]" class="form-control" readonly="readonly"></textarea></td>
						</tr>
					    `);
					d++;
				})
