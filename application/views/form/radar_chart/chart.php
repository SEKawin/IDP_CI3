            ...
            <div class="form-group">
                <div class="container-fluid ">
                    <div class="row ">
                        <div class="col border border-primary">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td name="manage_num"></td>
                                </tr>

                                <tr>
                                    <th>Functional Competency</th>
                                    <td name="func_num"></td>
                                </tr>
                        ...
                        <div class="col border border-primary">
                            <h4><u>
                                    <center>Core Competency</center>
                                </u></h4>
                            <div class="chart-myChart" style="position: relative; height:80%; width:80%">
                                <canvas id="cc_chart"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col border border-primary" id="chart_mc">
                            <h4><u>
                                    <center>Management Competency</center>
                                </u></h4>
                            <div class="chart-myChart" style="position: relative;">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col border border-primary">
                            <h4><u>
                                    <center>Functional Competency</center>
                                </u></h4>
                            <div class="chart-myChart" style="position: relative;">
...
<script type="text/javascript">
    function view_radarChart(code, years) {
        ...
        $('.modal_title_radar_chart').text('Radar Chart'); // Set Title to Bootstrap modal title
        $.ajax({
